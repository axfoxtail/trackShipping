...
$(document).ready(function() {
 	// Ascunde mesajul de Success
	$('.success').delay(3500).slideUp('slow');
	// Selecteaza in meniu pagina in care suntem
	var page = $("#page").attr('page');
	if(page == 'homepage') {
		$('#header-position').addClass('header-position');
	}
	$("[ispage='" + page + "']").addClass('current');
});
...
function googleTranslateElementInit() {
	...
	$('.goog-te-combo').css('background-color', '#EFEFEF').css('color','#414146').css('padding','5px').css('margin-left', '4px');
}
