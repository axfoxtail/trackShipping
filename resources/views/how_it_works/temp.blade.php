...
<div id="wrap" class="boxed">
	...
	<![endif]--> 
		...
		</header>	<b id="page" page="aboutpage"></b> 
...
<div class="container clearfix">
	...
	<div class="row">
		<div class="sixteen columns">
			<div class="styled-box iconed-box error"><p>* Your account is already active.</p></div>		</div>
	</div>
...
<div class="switcher">
	...
	<h2><b>Login</b> to your account <a href="#"><img class="s-s-icon" title="My Account" src="images/login.png" alt="Style switcher"/></a></h2>
	...
	<div class="content2">
		...
		<form class="loginForm" method="post" action="">
			...
			<p><i><a href="register.php" title="SIGN UP WITH US NOW!">SIGN UP WITH US NOW!</a></i></p>

			<button type="submit" name="login-formsubmit" class="button medium" style="width: 100%"><i class="icon-unlock"></i> Login</button>
