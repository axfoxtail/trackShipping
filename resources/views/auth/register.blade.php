...
<div id="wrap" class="boxed">
    ...
    <div class="row">
        <form action="{{ route('register') }}" id="private-form" method="post" class="clearfix">
            @csrf
            <div class="row">
                ...
                <div class="eight columns">
                    ...
                    <div class="row">
                        <fieldset class="field-1-3 left">
                            ...
                            <input type="text" name="fname" id="fname" placeholder="First name..." class="text m-bot-20" value="{{ old('fname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Last name</label>
                            <input type="text" name="lname" id="lname" placeholder="Last name..." class="text m-bot-20" value="{{ old('lname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Email address</label>
                            <input type="email" name="email" id="email" placeholder="Email..." class="text m-bot-20" value="{{ old('email') }}" required autocomplete="email">
                            @error('email')
      
                            <span for="lname" class="error">{{ $message }}</span>
                            @enderror
                        </fieldset>
                        
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Phone number</label>
                            <input type="tel" name="phone" id="phone" placeholder="Phone..." class="text m-bot-20" value="{{ old('phone') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">FAX number</label>
                            <input type="tel" name="fax" id="fax" placeholder="FAX..." class="text" value="{{ old('fax') }}">
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="eight columns">
                    ...
                    <div class="row">
                        <fieldset class="field-1-3 left">
                            ...
                            <input type="text" name="address" id="address" placeholder="Address..." class="text m-bot-20" value="{{ old('address')}}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">City</label>
                            <input type="text" name="city" id="city" placeholder="City..." class="text m-bot-20" value="{{ old('city')}}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Country</label>
                            <input type="text" name="country" id="country" placeholder="Country..." class="text m-bot-20" value="{{ old('country')}}">
                        </fieldset>
                        <!-- <fieldset class="field-1-3 left">
                            <label class="title-block">State</label>
                            <input type="text" name="state" id="state" placeholder="State..." class="text m-bot-20" value="{{ old('state')}}">
                        </fieldset> -->
                        <fieldset class="field-1-3 left">
                            <label class="title-block">ZIP Code</label>
                            <input type="text" name="postcode" id="postcode" placeholder="ZIP Code..." class="text m-bot-20" value="{{ old('postcode')}}">
                        </fieldset>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="eight columns">	
                    <fieldset class="field-1-3 left">
                        <label class="title-block">Email address</label>
                        <input type="email" placeholder="Partner email..." class="text m-bot-20" name="partner_email" value="{{ old('partner_email')}}" >
                    </fieldset>
                </div>		
            </div>
            ...
            <div class="row">
                <div class="eight columns">
                    <fieldset class="field-1-3 left">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" required autocomplete="name" autofocus id="username" placeholder="Username..." class="text m-bot-20">
                        @error('username')
                            <span for="lname" class="error">{{ $message }}</span>
                        @enderror
                    </fieldset>
                ...
                <div class="eight columns">
                    <fieldset class="field-1-3 left">
                        ...
                        <input type="password" name="password" required autocomplete="new-password" id="password" placeholder="Password..." class="text m-bot-20">
                        @error('password')
                            <span for="lname" class="error">{{ $message }}</span>
                        @enderror
                    </fieldset>
                    <fieldset class="field-1-3 left">
                        ...
                        <input type="password" name="password_confirmation" required autocomplete="new-password" id="rpassword" placeholder="Retype password..." class="text m-bot-20">
                    </fieldset>
                </div>		
            </div>
        ...
        <form action="{{ route('register') }}" id="business-form" method="post" class="clearfix">
            ...
            <div class="row">
                <div class="eight columns">
                    ...
                    <div class="row">
                        <fieldset class="field-1-3 left">
                            ...
                            <input type="text" name="fname" id="bname" placeholder="Firm Name..." class="text m-bot-20" value="{{ old('fname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Other Business Names (DBA)</label>
                            <input type="text" name="bname" id="bname" placeholder="Other Business Names..." class="text m-bot-20" value="{{ old('bname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Web address(URL)</label>
                            <input type="url" name="url" id="url" placeholder="http://..." class="text m-bot-20" value="{{ old('url') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Email address</label>
                            <input type="email" name="email" id="bemail" placeholder="Email..." class="text m-bot-20" value="{{ old('email') }}">
                            @error('email')
                            <span for="lname" class="error">{{ $message }}</span>
                            @enderror
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Phone number</label>
                            <input type="tel" name="phone" id="bphone" placeholder="Phone..." class="text m-bot-20" value="{{ old('phone') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">FAX number</label>
                            <input type="tel" name="fax" id="bfax" placeholder="FAX..." class="text" value="{{ old('fax') }}">
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="eight columns">
                    ...
                    <div class="row">
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Address</label>
                            <input type="text" name="address" id="baddress" placeholder="Address..." class="text m-bot-20" value="{{ old('address') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">City</label>
                            <input type="text" name="city" id="bcity" placeholder="City..." class="text m-bot-20" value="{{ old('city') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Country</label>
                            <input type="text" name="country" id="bcountry" placeholder="Country..." class="text m-bot-20" value="{{ old('country') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Post Code</label>
                            <input type="text" name="postcode" id="bpostcode" placeholder="Post Code..." class="text m-bot-20" value="{{ old('postcode') }}">
                        </fieldset>
                    </div>				
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="eight columns">
                    ...
                    <div class="row">
                        <fieldset class="field-1-3 left">
                            <label class="title-block">First name</label>
                            <input type="text" name="bfname" id="bfname" placeholder="First name..." class="text m-bot-20" value="{{ old('bfname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Last name</label>
                            <input type="text" name="blname" id="blname" placeholder="Last name..." class="text m-bot-20" value="{{ old('blname') }}">
                        </fieldset>
                        <fieldset class="field-1-3 left">
                            <label class="title-block">Title</label>
                            <input type="text" name="title" id="title" placeholder="Title..." class="text m-bot-20" value="{{ old('title') }}">
                        </fieldset>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="eight columns">
                    <fieldset class="field-1-3 left">
                        <label class="title-block">Username</label>
                        <input type="text" name="username" id="busername" placeholder="Username..." class="text m-bot-20" value="{{ old('username') }}">
                        @error('username')
                            <span for="lname" class="error">{{ $message }}</span>
                        @enderror
                    </fieldset>
                ...
                <div class="eight columns">
                    <fieldset class="field-1-3 left">
                        <label class="title-block">Password</label>
                        <input type="password" name="password" id="bpassword" placeholder="Password..." class="text m-bot-20" value="{{ old('password') }}">
                        @error('password')
                            <span for="lname" class="error">{{ $message }}</span>
                        @enderror
                    </fieldset>
                    <fieldset class="field-1-3 left">
                        <label class="title-block">Retype password</label>
                        <input type="password" name="password_confirmation" id="brpassword" placeholder="Retype password..." class="text m-bot-20" value="">
                    </fieldset>
                </div>		
            </div>
            <!-- END ROW -->
