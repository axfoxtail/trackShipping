...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand text-center" href="{{ url('/') }}">
                        <h4 class="mx-auto">PROCEED SHIPPING</h4>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    <!-- ============================================================== -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        <li class="nav-item d-none d-md-block" style="display: none"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>
                        <!-- ============================================================== -->
                        <!-- create new -->
                        <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('admin-assets/assets/images/users/1.jpg') }}" alt="user" class="rounded-circle" width="31"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div> -->
                                <a class="dropdown-item" href="javascript:void(0)" onclick="$('#logout-form').submit()"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                <form class="hidden" action="{{ route('logout') }}" method="POST" id="logout-form">
                                    @csrf
                                </form>
                                <!-- <div class="dropdown-divider"></div>
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> 
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="{{ url('/admin/users/business') }}" class="sidebar-link">
                                        <i class="mdi mdi-emoticon"></i>
                                        <span class="hide-menu"> Business </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ url('/admin/users/customers') }}" class="sidebar-link">
                        ...
                        <!-- <li class="sidebar-item"> 
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="{{ url('/admin/mails/contact') }}" class="sidebar-link">
                                        <i class="mdi mdi-inbox-arrow-down"></i>
                                        <span class="hide-menu"> Inbox </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ url('/admin/mails/sent') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/admin/mails/contact') }}" aria-expanded="false">
                                <i class="mdi mdi-inbox"></i>
                                <span class="hide-menu">Mail</span>
                            </a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/admin/transactions') }}" aria-expanded="false">
                                <i class="mdi mdi-receipt"></i>
                                <span class="hide-menu">Transactions</span>
                            </a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/admin/contact') }}" aria-expanded="false">
                                <i class="mdi mdi-phone"></i>
                                <span class="hide-menu">Conact Info</span>
                            </a>
                        </li>
                        <!-- <li class="sidebar-item"> 
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
    ...
    <!--Custom JavaScript -->
    <script src="{{ asset('admin-assets/dist/js/custom.min.js') }}"></script>496
